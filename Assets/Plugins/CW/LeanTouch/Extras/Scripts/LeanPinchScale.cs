...
namespace Lean.Touch
{
	...
	public class LeanPinchScale : MonoBehaviour
	{
		...
		public bool Relative { set { relative = value; } get { return relative; } } [SerializeField] protected bool relative;
		
		/// <summary>The sensitivity of the scaling.
		/// 1 = Default.
		/// 2 = Double.</summary>
		public float Sensitivity { set { sensitivity = value; } get { return sensitivity; } } [SerializeField] protected float sensitivity = 1.0f;
		...
		[SerializeField]
		protected Vector3 remainingScale;
